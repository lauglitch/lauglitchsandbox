...
function redirectToHomeES() {
    applyPageTransition("https://lauglitchsandbox.blogspot.com/");
}
function redirectToHomeEN() {
    applyPageTransition("https://lauglitchsandbox.blogspot.com/p/home.html");
}
function redirectToContactES() {
    applyPageTransition("https://lauglitchsandbox.blogspot.com/p/contacto.html");
}
function redirectToContactEN() {
    applyPageTransition("https://lauglitchsandbox.blogspot.com/p/contact.html");
}
...
function setGlobalVariables() {        
    ...
    if (currentURL === 'https://lauglitchsandbox.blogspot.com/') { 
        ...
        setSite('Home');
        setDevice('PC');
    } else if (currentURL === 'https://lauglitchsandbox.blogspot.com/p/home.html') {
        setLanguage('EN');
        setSite('Home');
        setDevice('PC');
    } else if (currentURL === 'https://lauglitchsandbox.blogspot.com/p/contacto.html') {
        setLanguage('ES');
        setSite('Contact');
        setDevice('PC');
    } else if (currentURL === 'https://lauglitchsandbox.blogspot.com/p/contact.html') {
        setLanguage('EN');
        setSite('Contact');
        setDevice('PC');
    } else if (currentURL === 'https://lauglitchsandbox.blogspot.com/p/contacto/done.html'){
        setLanguage('ES');
        setSite('Contact');
        setDevice('PC');
    } else if (currentURL === 'https://lauglitchsandbox.blogspot.com/p/contact/done.html'){
        setLanguage('EN');
        setSite('Contact');
        setDevice('PC');
    }
   // MOBILE VERSION
    else if (currentURL === 'https://lauglitchsandbox.blogspot.com/?m=1') {
        setLanguage('ES');
        setSite('Home');
        setDevice('Mobile');
    } else if (currentURL === 'https://lauglitchsandbox.blogspot.com/p/home.html?m=1') {
        setLanguage('EN');
        setSite('Home');
        setDevice('Mobile');
    } else if (currentURL === 'https://lauglitchsandbox.blogspot.com/p/contacto.html?m=1') {
        setLanguage('ES');
        setSite('Contact');
        setDevice('Mobile');
    } else if (currentURL === 'https://lauglitchsandbox.blogspot.com/p/contact.html?m=1') {
        setLanguage('EN');
        setSite('Contact');
        setDevice('Mobile');
    } else if (currentURL === 'https://lauglitchsandbox.blogspot.com/p/contacto/done.html?m=1'){
        setLanguage('ES');
        setSite('Contact');
        setDevice('PC');
    } else if (currentURL === 'https://lauglitchsandbox.blogspot.com/p/contact/done.html?m=1'){
        setLanguage('EN');
        setSite('Contact');
        setDevice('PC');
    } else {
...
function setDisplay(){
    ...
    if ((currentURL === 'https://lauglitchsandbox.blogspot.com/p/contacto/done.html') || (currentURL === 'https://lauglitchsandbox.blogspot.com/p/contact/done.html')
    || (currentURL === 'https://lauglitchsandbox.blogspot.com/p/contacto/done.html?m=1') ||(currentURL === 'https://lauglitchsandbox.blogspot.com/p/contact/done.html?m=1')){
